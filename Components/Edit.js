...
class GroomerCard extends React.Component {
  state = {
    date: this.props.route.params.otherParam.otherParam.date,
    time: this.props.route.params.otherParam.otherParam.time,
    Expanded: false
	};
  ...
  postAppointment = () => {
    fetch(`http://localhost:3000/appointments/${this.props.route.params.otherParam.otherParam.id}`, {
      method: "PATCH",
      headers: {
      ...
      body: JSON.stringify({
        ...
        groomer_id: this.props.route.params.otherParam.groomerParam.id,
...
//   postCart = (id) => {
//     fetch("http://localhost:3000/serviceappointments", {
//       method: "PATCH",
//       headers: {
//         accepts: "application/json",
//         "content-type": "application/json",
...
//   }
  ...
  timeAccordion=()=>{
    if (this.state.date !== null) {
      return (
        <>
        <Text style={webWeights.caption}>Available Times For:</Text><List.Section title={this.state.date}>
      <List.Accordion
    ...
    return (
      <>
       <View
        ...
        >
          <Text style={webWeights.headline}>{this.props.route.params.otherParam.groomerParam.name}</Text>
        </View>
        <ScrollView>
          <Text style={webWeights.caption}>Pick a Date</Text>
        <Calendar
           theme={{
